//! Rust release-gate engine for Competition Deck Grader.
//!
...
pub const PRODUCT_SLUG: &str = "competition-deck-grader";
pub const PRODUCT_TITLE: &str = "Competition Deck Grader";
