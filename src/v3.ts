export const v3 = {
  "productName": "Competition Deck Grader",
  ...
  "capabilities": [
    "Domain-specific workbench: Competition Judging Console",
    "Operational table: Deck scorecards",
  ...
  "releaseChecklist": [
    ...
    "Rubric Score reaches production threshold",
    "Judge Variance is documented with evidence",
    "Finalist Readiness has no unresolved blocker",
    "Scorecards verified",
    "Calibration report verified",
    "Feedback summaries verified"
  ],
  "operations": [
