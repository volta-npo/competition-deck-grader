...
**Competition Deck Grader** is a polished, local-first open-source tool from Volta's open-source program. It helps Judges, contestants, and chapter reviewers turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
