...
# 🎓 Competition Deck Grader

### An open rubric runner for Volta’s Digital Transformation Challenge pitch decks.
...
**Student Agency Operations** · **Repo 49/50** · **No backend. No login. Client data stays local.**
...
**Competition Deck Grader** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Judges, contestants, and chapter reviewers turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Competitions need transparent scoring that rewards real-world grounding, specificity, clarity, creativity, and impact.

### The niche

High-school digital transformation competitions.

### North-star metric

`decks scored consistently across reviewers`
...
flowchart TD
    ...
    Evidence --> Workbench["Competition Deck Grader"]
    Workbench --> Score["Operating readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["Scorecards"]
    Cert --> A2["Calibration report"]
    Cert --> A3["Feedback summaries"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Rubric scorecards"]
        M2["Evidence checklist"]
        M3["Judge calibration notes"]
        M4["Feedback summary builder"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Competition Deck Grader
...
|---|---|
| **Domain workbench** | A purpose-built deck grader interface for an open rubric runner for volta’s digital transformation challenge pitch decks. |
...
|---:|---|---|
| 1 | **Rubric scorecards** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Evidence checklist** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Judge calibration notes** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Feedback summary builder** | Converts field work into repeatable, reviewable Volta delivery evidence. |
